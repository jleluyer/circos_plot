...
#### Test real data
temp.seg.f<-read.table("02_data/example_init.seg.txt",header=T)
data_label_methyl<-read.table("02_data/example_gene.label.txt",header=T)
data_value_methyl<-read.table("02_data/example_data.methyl.txt",header=T)
...
#plot
jpeg(filename = "03_results/circos_plot.jpeg",
